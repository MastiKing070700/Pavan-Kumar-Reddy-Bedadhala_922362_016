 ...
 * 		This should be applied to a Spring java config and should have 
 * 		an accompanying '@Configuration' annotation.
 * 		Loads all required beans defined in SpringSwaggerConfig
 * 
 * 		@EnableAutoConfiguration attempts to guess and
 * 		configure beans that we are likely to need.
 *
 */
