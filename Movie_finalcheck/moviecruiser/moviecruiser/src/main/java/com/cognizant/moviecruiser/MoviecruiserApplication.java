...
public class MoviecruiserApplication {
	...
	private static void testModifyMovie() {
		LOGGER.info("Start");
		Movie newMovie = new Movie(2, "Spider Man", "$1,518,812,988", "Yes", DateUtil.convertToDate("29/08/2019"),
				"Fictional", "Yes");
	...
	private static void testSaveAllMovies() {
		...
		movie = new Movie(6,"Frozen", "$2,787,965,087", "Yes", DateUtil.convertToDate("02/09/2017"), "Fiction", "Yes");
		saveMovieList.add(movie);
		movie = new Movie(7,"Captain Marvel", "$1,518,812,988","Yes", DateUtil.convertToDate("12/04/2018"), "Fiction",
				"No");
		saveMovieList.add(movie);
